		 ...
		 public General(){
			 ...
			 jComboBox.addItemListener(new ItemListener() {
				...
				public void itemStateChanged(ItemEvent arg0) {
					generalColor = (String) jComboBox.getSelectedItem();
				}
			});
		...
		private class ColorChooserPanel extends JFrame{
				...
				buttonOk.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						if(ColorChooserPanel.this.object.equals(panelTextColor)){
							...
							ColorChooserPanel.this.setVisible(false);
						}
						else  {
		 ...
		 public Text(){
				...
				comboBox.addItemListener(new ItemListener() {
					@Override
					public void itemStateChanged(ItemEvent e) {
						textFont = (String) comboBox.getSelectedItem();
					}
				});
				...
				comboBox_1.addItemListener(new ItemListener() {
					@Override
					public void itemStateChanged(ItemEvent e) {
						textAlignment = (String) comboBox_1.getSelectedItem();
					}
				});
...
private class ColorChooserPanel extends JFrame{
		...
		public Line() {
				...
				comboBox.addItemListener(new ItemListener() {
					@Override
					public void itemStateChanged(ItemEvent e) {
						lineType = (String) comboBox.getSelectedItem();
					}
				});
		 ...
		 private JTextField jTextFieldEdgeSize;
			...
			public Solid() {
				...
				comboBoxEdgeType.addItemListener(new ItemListener() {
					@Override
					public void itemStateChanged(ItemEvent e) {
						solidEdgeType = (String) comboBoxEdgeType.getSelectedItem();
					}
				});
				...
				comboBoxIterior.addItemListener(new ItemListener() {
					@Override
					public void itemStateChanged(ItemEvent e) {
						solidIterior = (String) comboBoxIterior.getSelectedItem();
					}
				});
	...
	public DrawOptions(int x,int y){
		buttonOk = new JButton("OK");
		buttonOk.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		...
		DrawOptions.this.add(subDrawOptions);
		...
		jTabbedPane.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				{
					DrawOptions.this.setBounds(DrawOptions.this.getX(), DrawOptions.this.getY(), 710*screenWidth/65535, 410*screenHeight/65535);
					...
					subDrawOptions.setVisible(false);
					DrawOptions.this.setBounds(DrawOptions.this.getX(), DrawOptions.this.getY(), 350*screenWidth/65535, 410*screenHeight/65535);
				}
			}
		});
		add(jTabbedPane);
