...
import net.sf.jcgm.core.PointFactory;
...
public class ControlPathPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent evt) {
		mouseX = evt.getX();
		mouseY = evt.getY();
        System.out.println("Moved "+mouseX+","+mouseY);
	...
	private void findClosestLineSegment(double x, double y) {
		...
		System.out.println("1: "+closestPointIndex1);
		System.out.println("2: "+closestPointIndex2);
	}
